        ...
        <div className="w-[360px] max-w-full overflow-hidden rounded-[1.75rem] border border-lime-300/20 bg-[#07110d]/95 shadow-2xl backdrop-blur-xl">
          ...
          <div className="p-5">
            ...
            {submitted ? (
              ...
              <p className="mt-4 text-xs leading-5 text-white/40">Ask about tracking, learning, accounts, or wallet connection. When server AI is configured, answers are generated there; otherwise Skooby uses its built-in guided help.</p>
            )}
